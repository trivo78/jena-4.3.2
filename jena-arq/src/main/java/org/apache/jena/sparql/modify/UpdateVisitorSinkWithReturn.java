 ...
 * @author Lorenzo
 */
public class UpdateVisitorSinkWithReturn implements UpdateSinkWithReturn{
    private final UpdateVisitor worker;
    private final Sink<Quad> addSink;
    private final Sink<Quad> delSink;
    
    public UpdateVisitorSinkWithReturn(UpdateVisitor worker, Sink<Quad> addSink, Sink<Quad> delSink) {
        this.worker = worker;
