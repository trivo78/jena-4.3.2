...
finishQuery() ;
  ...
  final public List<UpdateResult> UpdateUnit() throws ParseException {
      List<UpdateResult> ret = null;
    ByteOrderMark();
    startUpdateRequest() ;
    ret = Update();
    jj_consume_token(0);
...
finishValuesClause(t.beginLine, t.beginColumn) ;
  ...
  final public List<UpdateResult> Update() throws ParseException {
  ...
  final public UpdateResult Update1() throws ParseException {
      Update up = null ;
